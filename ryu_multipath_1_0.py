...
class ProjectController(app_manager.RyuApp):
    ...
    def install_paths(self, src, first_port, dst, last_port, ip_src, ip_dst):
        ...
        #print "path_with ports ", paths_with_ports[0][src][1]
...
#        if pkt_icmp:
#            print pkt_icmp
#            print colored('Alguem esta pingando','blue')
        #if out2:
        #    data = None
        #    if msg.buffer_id == ofproto.OFP_NO_BUFFER:
        #        data = msg.data
        #    print "Installing a new path"
        #    out = parser.OFPPacketOut(
        #            datapath=datapath, buffer_id=msg.buffer_id, in_port=in_port,
        #            actions=actions, data=data)
...
#--------------------------------------------------------------------------------
        ...
        if dpid == 3:
            for stat in sorted(body, key=attrgetter('port_no')):
                ...
                if stat.port_no == 3:
                    ...
                    band_3_3 = (tx_fin_3_3-tx_ini_3_3)*8
                    result_3_3 = int(band_3_3/1048576)
                    ...
                    throuput = result_3_3 + result_rx_3_3
                    
                    #Regras de Contexto: Congestionamento severo 
                    #Se o throuput maior que 80% da banda
                    if (throuput > MAX_BAND*0.8):
                        print colored(MAX_BAND, 'red')
                        print colored(throuput,'red')
           ...
           for stat in sorted(body, key=attrgetter('port_no')):
               #SELECIONA A PORTA 1
                if stat.port_no == 1:
                    ...
                    result_4_1 = int(band_4_1/1048576) #divide 1Mb
    ...
    def port_status_handler(self, ev):
        ...
        if msg.reason == ofp.OFPPR_MODIFY: reason = 'MODIFY'
        if msg.desc.state == ofp.OFPPS_LINK_DOWN:
            ...
            if (C > 0 and src and dst and first_port and last_port):
                ...
                #armazena os ips de origem e destino
            ...
            if (C == 2): 
                ...
                if src and dst:
                    ...
                    self.remove_flows(src, 0)#chama a função para remover fluxo do dp de origem
                    self.remove_flows(dst, 0)#chama a função para remover fluxo do dp de destino
